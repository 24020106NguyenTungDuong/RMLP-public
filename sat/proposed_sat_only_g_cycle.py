"""Radio Mean Labeling solver: only-G encoding, cycle graphs.

Uses symmetry_breaking_cycle() (valid because a cycle's full automorphism
group makes vertex 1 and vertex n-1 interchangeable) plus a vertex-0
label-pinning assumption; both are cycle-specific and NOT used by the
path/general only-G variants.
"""
...
def is_sat(k):
    ...
    while True:
        ...
        assum.append(get_var_G(0, k - n + 1))
