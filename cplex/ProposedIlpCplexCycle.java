 ...
 * l1+l2 < H(u,v)), plus cycle-specific symmetry breaking (vertex-0 pin,
 * reflection break) -- sound only for cycle graphs, whose full
 * rotational/reflective automorphism group justifies them.
 *
 * Build:
 *   javac -cp <CPLEX_STUDIO_DIR>/cplex/lib/cplex.jar ProposedIlpCplexCycle.java
 * Run:
 *   java -cp .:<CPLEX_STUDIO_DIR>/cplex/lib/cplex.jar \
 *        -Djava.library.path=<CPLEX_STUDIO_DIR>/cplex/bin/x86-64_linux \
 *        ProposedIlpCplexCycle [timeLimitSeconds] < input.txt
 */
...
public class ProposedIlpCplexCycle {
